...
Ultima Atualizacao: 2026-05-30 19:35
Status: Ativo
---
...
### [SCAR-002] Colisão de Bytecode Python no SAM (Falso Positivo) (Score: 240)
- **Última vez:** api_notion_crm (2026-05-30)
- **O que aconteceu:** Falsos positivos de Modificação Silenciosa causados por arquivos `.pyc` (bytecode Python) gerados em runtime. -> O interpretador Python gerava ou modificava arquivos compilados `.pyc` dentro de `__pycache__` durante a execução do harness. Como esses binários estavam trackeados anteriormente no Git index, o SAM os enxergava como arquivos modificados e bloqueava o pipeline por não estarem na Matriz de Propagação.
- **A Regra:** Ignorar arquivos de runtime/bytecode auto-gerados no auditor do SAM e assegurar exclusão física no Git.

### [SCAR-003] Execução Irresponsável (Bypass de Planejamento) (Score: 171)
...
### [SCAR-004] Configuração Híbrida Inválida (Modo Sprint vs Standard) (Score: 108)
...
### [SCAR-005] Drift de Baseline (start_hash desatualizado) (Score: 108)
- **Última vez:** governance_rules_hardening (2026-04-30)
...
### [SCAR-006] Fechamento Prematuro de Task (Acceptance Pendente) (Score: 108)
- **Última vez:** governance_rules_hardening (2026-04-30)
...
### [SCAR-007] Deriva de Atenção e Falhas de Regex (Surgical Edits) (Score: 90)
...
### [SCAR-008] Substituição Cega (Drift de Target Content) (Score: 90)
...
- **[LOOP DETECTADO]** Spec `manual` falhou 10 vezes recentemente. Requer análise estratégica.
- **[LOOP DETECTADO]** Spec `blast_radius_mvp` falhou 7 vezes recentemente. Requer análise estratégica.
- **[LOOP DETECTADO]** Spec `teste_trivial_dryrun` falhou 5 vezes recentemente. Requer análise estratégica.
