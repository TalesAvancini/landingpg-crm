...
| `@spec-driver` | Executor Chain-Skills V3 (9 Skills), Gatekeeper Compliance, Anti-Loop Remediation | `.specs/`, `src/`, `tests/`, `contract` (frontmatter) | `*.enriched.md`, `STATE.md`, `JOURNAL.md`, `brain/RULES.md`, `AGENT_SCRATCHPAD.md` | `"inicie execução"`, `"autopilot"`, `"execute a spec"`, `"MIMO close"` |
