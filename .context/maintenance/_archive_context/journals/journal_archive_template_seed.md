...
Ultima Atualizacao: 2026-05-29 22:04
Status: Ativo
...
- [x] **Toque de Sincronia:** Atualizados metadados in `RULES.md`, `MASTER_FLOW.md`, `FILE_GLOSSARY.md` e `SCRIPT_GLOSSARY.md` para cumprir as regras do SAM.
...
**Estado Atual:**
- [x] **Otimização de Contexto:** Modificada a Condição 3 no GEMINI.md para exigir a leitura de orquestrador.md apenas na fase de inicialização do papel (Onboarding/Boot), prevenindo consumo redundante de tokens em turnos subsequentes da mesma sessão.
...
**Estado Atual:**
- [x] **Ajuste Comportamental:** Adicionadas diretivas explícitas no orquestrador.md proibindo o "Complexo de Super-Herói" (intervir diretamente no código de produção quando executores falharem) e proibindo iniciativas de alteração autônomas sem demanda do usuário.
...
**Estado Atual:**
- [x] **Centralização de Regras:** Consolidado o roteador de regras condicionais do regras_roteadas.md diretamente no GEMINI.md na raiz do projeto.
